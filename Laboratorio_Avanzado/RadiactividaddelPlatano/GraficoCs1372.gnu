...
set output 'grafico_Cs137_medicion2.png'

# Configuración del Título y Ejes
set title "Espectro de Cesio-137 (Medición 2)"
set xlabel "Canal"
set ylabel "Cuentas"
set grid
set key top right
...
# Graficar y Guardar
plot "Cs137verdader2.txt" using 1:2 with lines lw 2 lc rgb "green" title "Cs-137 (M2)"
